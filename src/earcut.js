/* UltraGame - triangulación de polígonos (algoritmo "ear clipping" con agujeros y hash por curva Z,
 * implementación propia basada en el algoritmo público de earcut). */
var Earcut = (function () {
  ...
  function splitPolygon(a, b) {
    var a2 = new ENode(a.i, a.x, a.y), b2 = new ENode(b.i, b.x, b.y), an = a.next, bp = b.prev;
    a.next = b; b.prev = a;
  ...
  function ENode(i, x, y) { this.i = i; this.x = x; this.y = y; this.prev = null; this.next = null; this.z = 0; this.prevZ = null; this.nextZ = null; this.steiner = false; }
  function signedArea(data, start, end, dim) {
    var sum = 0;
    for (var i = start, j = end - dim; i < end; i += dim) { sum += (data[j] - data[i]) * (data[i + 1] + data[j + 1]); j = i; }
    return sum;
  }
  earcut.signedArea = function (data) { return signedArea(data, 0, data.length, 2); };
  return earcut;
})();
UG.Earcut = Earcut;
